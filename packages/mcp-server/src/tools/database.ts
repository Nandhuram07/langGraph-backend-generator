...
import type { EntityDef, DbType, EntityField } from "./generate.js";
...
function mysqlType(f: EntityField): string {
  switch (f.type) {
...
function mssqlType(f: EntityField): string {
  switch (f.type) {
...
function buildMysqlDDL(entity: EntityDef): string {
...
function buildMssqlDDL(entity: EntityDef): string {
  const cols = entity.fields
...
async function runMysql(entities: EntityDef[], cfg: DbConfig): Promise<string[]> {
...
async function runMssql(entities: EntityDef[], cfg: DbConfig): Promise<string[]> {
...
export async function setupDatabase(input: SetupDbInput): Promise<SetupDbResult> {
